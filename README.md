...
<h3 align="center">Software Engineer with keen interest in building business solutions and scalable web applications using Spring Framework and Micro Services. Proficient in developing secure APIs, optimizing front-end user interfaces, and managing databases like PostgreSQL, MySQL, and MongoDB. Skilled in Agile development, DevOps practices with Jenkins, and cloud technologies such as AWS and Microsoft Azure. Proven track record in delivering projects that improve business efficiency, including ERP and E-commerce platforms.</h3>
